...
$taborder=array(9,0,4,3,2,0,1,8,19,16,0,5,11,0,6,0,10,25,12,13,0,14,0,7,17,0,22,20,18,21,0,15,0,24,23,26);
...
$tabname[26]= MAIN_DB_PREFIX."c_email_templates";
...
$tablib[26]= "DictionaryEMailTemplates";
...
$tabsql[26]= "SELECT rowid   as rowid, label, type_template, private, position, topic, content, active FROM ".MAIN_DB_PREFIX."c_email_templates WHERE entity=".$conf->entity;
...
$tabfield[26]= "label,type_template,private,position,topic,content";
...
$tabfieldvalue[26]= "label,type_template,private,position,topic,content";
...
$tabfieldinsert[26]= "label,type_template,private,position,topic,content,entity";
...
$tabcond[25]= true;
$tabcond[26]= true; // && ! empty($conf->global->MAIN_EMAIL_EDIT_TEMPLATE_FROM_DIC);
